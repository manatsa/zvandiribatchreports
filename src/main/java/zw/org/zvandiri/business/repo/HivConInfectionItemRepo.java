 ...
 */
public interface HivConInfectionItemRepo extends JpaRepository<HivConInfectionItem, String> {
    ...
    List<HivConInfectionItem> findByActive(@Param("active")Boolean aTrue);
}