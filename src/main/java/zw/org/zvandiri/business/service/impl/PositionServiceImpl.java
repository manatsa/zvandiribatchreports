...
import zw.org.zvandiri.business.repo.PositionRepo;
...
public class PositionServiceImpl implements PositionService {
    ...
    public List<Position> getAll() {
        return positionRepo.getOptAll(Boolean.TRUE);
    }
    ...
    @Override
    public List<Position> getPageable() {
    ...
    @Override
    public Boolean checkDuplicate(Position current, Position old) {
