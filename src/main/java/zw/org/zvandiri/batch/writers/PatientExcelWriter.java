...
@Component("patientExcelWriter")
public class PatientExcelWriter implements ItemWriter<Patient> {
   ...
   @Autowired
    ...
    public PatientExcelWriter(HttpServletResponse response) {
    ...
    public void afterStep(StepExecution stepExecution) {
        ...
        try(ServletOutputStream myOut = response.getOutputStream()) {
            ...
            response.setHeader("Content-Disposition", "filename=Patient_Detailed_Report_"+suffix+".xlsx");
    ...
    public void beforeStep(StepExecution stepExecution) {
        workbook = new SXSSFWorkbook(Constants.CHUNK_SIZE);
